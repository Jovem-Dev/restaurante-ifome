...
import PedidoAnteriorDetalhe from './pedido-anterior-detalhe';

class CardInvoiceAnterior extends Component {
                    ...
                    <Card >
                        <CardBody>
                            <Row>
                                ...
                                <Col lg="6">
                                    <div>
                                        <Link to="/pedido-anterior-detalhe" className="d-block text-primary mb-2">Oferta #{this.props.data.id}</Link>
                                ...
                                <Route exact path="/pedido-anterior-detalhe" render={ (props) => <PedidoAnteriorDetalhe {...props} id={id} />}/>
                            </Row>
                        </CardBody>
                    </Card>
                </Col>
...
export default CardInvoiceAnterior;